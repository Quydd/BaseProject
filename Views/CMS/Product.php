...
<script>
  function deleteProduct(id){
    $.post( "<?=Config::$urlbase?>Controllers/CMS/Product.php",{id:id,action:"delete"}, function( data ) {
      // console.log(data);
  ...
  function editProduct(id){
    $.post( "<?=Config::$urlbase?>Controllers/CMS/Product.php",{id:id,action:"view-edit"}, function( data ) {
