...
include_once('../../Views/Home/Layouts/Header.php');
$products = Cart::getList();
if($_SESSION['user'] == null){
    header('Location: '.Config::$urlbase.'views/pages/login.php');
}
?>
<div class="container">
    <div class="row">
        ...
        <div class="main-page main-cart">
            ...
            <div class="page-content page-order">
                ...
                <div style="width: 100%; background-color: white;  padding: 40px;">
                    <img src="<?=Config::$urlbase?>upload/empty.jpg" style="width: 50%; margin-left:25%; margin-top: 30px;" alt="">
                </div>
                <?php }?>
                        ...
                        <tbody>
                            ...
                            <tr style="min-height: 20px;vertical-align: middle;">
                                <td class="cart_product">
                                    <a href="<?=Config::$urlbase.'views/pages/product_detail.php?product='.$product->product->id?>">
                                ...
                                <td class="cart_description" style="max-height: 200px; display: block; overflow: auto;">
                                    <p class="product-name"><a href="<?=Config::$urlbase.'views/pages/product_detail.php?product='.$product->product->id?>"><?= $product->product->name ?></a></p>
                                ...
                                <td class="quantity" data-id="<?=$product->product->id?>" style="text-align: center;">
                                    <form action="<?=Config::$urlbase?>Controllers/Home/Cart.php" method="post">
                                    <input type="hidden" name="is_count" value="true">
                                ...
                                <td class="cart_avail" style="font-size: 20px; color: red;">
                                    <form method="post" action="<?=Config::$urlbase?>Controllers/Home/Cart.php" >
