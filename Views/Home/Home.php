            ...
            <div class="block block-hot-deals">
                <div class="block-head">
                    <div class="block-title">
                        <div>
                            <div>
                                <img style="width: 48px;" src="<?= $category->icon ?>" alt="<?= $category->name ?> icon">
                            </div>
                            <span class="" style="display:block; color: #FF7E7E; font-weight: bold; text-align: center;"><?= $category->name ?></span>
                        </div>
                        <a class="button-radius view_more" href="<?=Config::$urlbase.'views/pages/product_of_category.php?category='.$category->id?>" title="View all" style="color: #FF7E7E;">View all<span class="icon"></span></a>
                    </div>
                </div>
                                ...
                                <div class="product-container">
                                    <div class="product-left">
                                        <div class="product-thumb">
                                            <a class="product-img" href="<?=Config::$urlbase.'Views/Home/ProductDetail.php?product='.$product->id?>">
                                    ...
                                    <div class=" product-right">
                                        <div class="product-name">
                                            <a title="View detail" href="<?=Config::$urlbase.'Views/Home/ProductDetail.php?product='.$product->id?>"><?=$product->name?></a>
                                        </div>
                                        <div class="price-box">
                                        ...
                                        <div class="product-button" style="padding: 2px;">
                                            <a class="button-radius btn-add-cart" href="<?=Config::$urlbase.'Views/Home/ProductDetail.php?product='.$product->id?>" title="Add to Cart">Buy<span class="icon"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
