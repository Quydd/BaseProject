...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="image/png" href="<?=Config::$urlbase?>vendor/frontend/images/logo_red.png " sizes="32x32" />
    <!-- Css stylesheet -->
    ...
    <link rel="stylesheet" type="text/css" href="<?=Config::$urlbase?>vendor/frontend/fonts/Font-Awesome/css/font-awesome.min.css" />
    ...
    <link rel="stylesheet" type="text/css" href="<?=Config::$urlbase?>vendor/frontend/css/global.css?<?= date('l jS \of F Y h:i:s A') ?>" />
    <link rel="stylesheet" type="text/css" href="<?=Config::$urlbase?>vendor/frontend/css/style.css?<?= date('l jS \of F Y h:i:s A') ?>" />
    <link rel="stylesheet" type="text/css" href="<?=Config::$urlbase?>vendor/frontend/css/responsive.css?<?= date('l jS \of F Y h:i:s A') ?>" />
    <link rel="stylesheet" type="text/css" href="<?=Config::$urlbase?>vendor/frontend/css/custom.css?<?= date('l jS \of F Y h:i:s A') ?>" />
            ...
            <div class="">
                <div class="">
                    <ul class="top-bar-link top-bar-link-right dot">
                        <?php if (!$user) { ?>
                            <li><a href="<?=Config::$urlbase?>Views/Home/Login.php">Sign in</a></li>
                            <li><a href="<?=Config::$urlbase?>Views/Home/Login.php">Sign up</a></li>
                        <?php
                        } else {
                            ...
                            <li class="dropdown-item">
                                <form method="post" action="<?=Config::$urlbase?>controller/user.php">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="logo text-center">
                                <a href="<?=Config::$urlbase?>Views/Home/Home.php">
                                    <img src="<?=Config::$urlbase?>vendor/frontend/images/logo_white.png" alt="Logo" style="height: 100px ; margin: -20px -10px">
                        ...
                        <div id="search_form" class="col-sm-6 col-md-7 col-lg-6 col-xs-12">
                            ...
                            <div class="box-radius advanced-search">
                                <form class="form-inline" method="get" action="<?=Config::$urlbase?>Views/Home/search.php">
                        ...
                        <div class="col-lg-2 col-md-2  col-sm-2 col-xs-12  left_bar_icon" style="justify-content: space-around; display: flex;">
                            ...
                            <div class="block-wrap-cart ">
                                <div class="">
                                    <a href="<?=Config::$urlbase?>Views/Home/Cart.php" class="fa fa-shopping-cart shopping_icon not0">
